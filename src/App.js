    ...
    function App() {
      const CONTRACT_ADDRESS = "0x7B0A5e71e18c03D490Da50B720B42051d98bC3F5";    //0xc7499436241d97f3a6c6718389652bf6faa95653
      const ABI = [
        {
          "inputs": [
            {
        ...
        return (
          <div className="App">
              ...
              <div className="list-item">
                  ...
                  <input id="itemPrice" placeholder="Item Price (in RBTC)" className="input-field" />
              ...
              <div className="items">
                  ...
                  {items.map((item) => (
                      <div key={item.id} className="item-card">
                          ...
                          <p><strong>Price:</strong> {ethers.utils.formatEther(item.price)} RBTC</p>
